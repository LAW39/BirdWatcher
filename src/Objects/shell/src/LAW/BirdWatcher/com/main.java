...
public static LAW.BirdWatcher.com.codefunctions _codefunctions = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",main.mostCurrent._activity,"BirdPhotoPath",main._birdphotopath,"CodeFunctions",Debug.moduleToString(LAW.BirdWatcher.com.codefunctions.class),"Map",Debug.moduleToString(LAW.BirdWatcher.com.map.class),"Reload_BTN",main.mostCurrent._reload_btn,"Sightings",Debug.moduleToString(LAW.BirdWatcher.com.sightings.class),"Species",Debug.moduleToString(LAW.BirdWatcher.com.species.class),"SpeciesCursor",main.mostCurrent._speciescursor,"Starter",Debug.moduleToString(LAW.BirdWatcher.com.starter.class)};
}
}