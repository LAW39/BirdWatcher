...
public static LAW.BirdWatcher.com.codefunctions _codefunctions = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",sightings.mostCurrent._activity,"AddNow",sightings.mostCurrent._addnow,"BirdAppearance",sightings.mostCurrent._birdappearance,"BirdPhotoView",sightings.mostCurrent._birdphotoview,"CodeFunctions",Debug.moduleToString(LAW.BirdWatcher.com.codefunctions.class),"Date",sightings.mostCurrent._date,"FlockSize",sightings.mostCurrent._flocksize,"Main",Debug.moduleToString(LAW.BirdWatcher.com.main.class),"Map",Debug.moduleToString(LAW.BirdWatcher.com.map.class),"MapLookupFlag",sightings._maplookupflag,"SelectedID",sightings._selectedid,"Species",Debug.moduleToString(LAW.BirdWatcher.com.species.class),"SpeciesList",sightings.mostCurrent._specieslist,"Starter",Debug.moduleToString(LAW.BirdWatcher.com.starter.class),"Time",sightings.mostCurrent._time,"WeatherConditions",sightings.mostCurrent._weatherconditions};
}
}