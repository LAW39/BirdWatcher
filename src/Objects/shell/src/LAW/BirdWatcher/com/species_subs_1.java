...
species.mostCurrent._activity.runMethod(false,"setTitle",RemoteObject.createImmutable(("Species")));
 BA.debugLineNum = 36;BA.debugLine="SpeciesListView.Color = Colors.black";
Debug.ShouldStop(8);
species.mostCurrent._specieslistview.runVoidMethod ("setColor",species.mostCurrent.__c.getField(false,"Colors").getField(true,"Black"));
