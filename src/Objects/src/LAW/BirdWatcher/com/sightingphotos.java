...
RDebugUtils.currentLine=3211267;
 //BA.debugLineNum = 3211267;BA.debugLine="Log(SightID)";
anywheresoftware.b4a.keywords.Common.Log(BA.NumberToString(_sightid));
RDebugUtils.currentLine=3211268;
 //BA.debugLineNum = 3211268;BA.debugLine="Activity.LoadLayout(\"SightingPhotos\")";
mostCurrent._activity.LoadLayout("SightingPhotos",mostCurrent.activityBA);
RDebugUtils.currentLine=3211269;
 //BA.debugLineNum = 3211269;BA.debugLine="Phototab.LoadLayout(\"PhotoTab\",\"Species Picture\")";
mostCurrent._phototab.LoadLayout("PhotoTab",(java.lang.CharSequence)("Species Picture"));
RDebugUtils.currentLine=3211270;
 //BA.debugLineNum = 3211270;BA.debugLine="Load_Photos(SightID)";
_load_photos(_sightid);
RDebugUtils.currentLine=3211271;
 //BA.debugLineNum = 3211271;BA.debugLine="Activity.Title = (\"Photos\")";
mostCurrent._activity.setTitle((Object)(("Photos")));
RDebugUtils.currentLine=3211272;
 //BA.debugLineNum = 3211272;BA.debugLine="Log(SightingPhotoList.Size)";
anywheresoftware.b4a.keywords.Common.Log(BA.NumberToString(_sightingphotolist.getSize()));
RDebugUtils.currentLine=3211273;
 //BA.debugLineNum = 3211273;BA.debugLine="For i = 0 To SightingPhotoList.Size-1";
{
final int step7 = 1;
...
RDebugUtils.currentLine=3211275;
 //BA.debugLineNum = 3211275;BA.debugLine="Dim PhotoInt As String = i+1";
_photoint = BA.NumberToString(_i+1);
RDebugUtils.currentLine=3211276;
 //BA.debugLineNum = 3211276;BA.debugLine="Phototab.LoadLayout(\"PhotoTab\",PhotoInt)";
mostCurrent._phototab.LoadLayout("PhotoTab",(java.lang.CharSequence)(_photoint));
 }
};
RDebugUtils.currentLine=3211279;
 //BA.debugLineNum = 3211279;BA.debugLine="Phototab_PageSelected (0)";
...
RDebugUtils.currentLine=3276800;
 //BA.debugLineNum = 3276800;BA.debugLine="Sub Load_Photos(SightingID As Int)";
RDebugUtils.currentLine=3276801;
 //BA.debugLineNum = 3276801;BA.debugLine="SightingPhotoList.Initialize";
_sightingphotolist.Initialize();
RDebugUtils.currentLine=3276802;
 //BA.debugLineNum = 3276802;BA.debugLine="Log(SightingID)";
anywheresoftware.b4a.keywords.Common.Log(BA.NumberToString(_sightingid));
RDebugUtils.currentLine=3276803;
 //BA.debugLineNum = 3276803;BA.debugLine="Dim SpeciesCursor As Cursor";
_speciescursor = new anywheresoftware.b4a.sql.SQL.CursorWrapper();
RDebugUtils.currentLine=3276804;
 //BA.debugLineNum = 3276804;BA.debugLine="Dim SQLQuery As StringBuilder";
_sqlquery = new anywheresoftware.b4a.keywords.StringBuilderWrapper();
RDebugUtils.currentLine=3276805;
 //BA.debugLineNum = 3276805;BA.debugLine="Dim SightingPicture As Bitmap";
_sightingpicture = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
RDebugUtils.currentLine=3276806;
 //BA.debugLineNum = 3276806;BA.debugLine="Dim BirdPhotoFile As Double";
_birdphotofile = 0;
RDebugUtils.currentLine=3276807;
 //BA.debugLineNum = 3276807;BA.debugLine="SQLQuery.Initialize";
_sqlquery.Initialize();
RDebugUtils.currentLine=3276808;
 //BA.debugLineNum = 3276808;BA.debugLine="SQLQuery.Append(\"SELECT PhotoDir\").Append(CRLF)";
_sqlquery.Append("SELECT PhotoDir").Append(anywheresoftware.b4a.keywords.Common.CRLF);
RDebugUtils.currentLine=3276809;
 //BA.debugLineNum = 3276809;BA.debugLine="SQLQuery.Append(\"FROM SightingPhoto\").Append(CRLF";
_sqlquery.Append("FROM SightingPhoto").Append(anywheresoftware.b4a.keywords.Common.CRLF);
RDebugUtils.currentLine=3276810;
 //BA.debugLineNum = 3276810;BA.debugLine="SQLQuery.Append(\"LEFT JOIN Sightings ON Sightings";
...
RDebugUtils.currentLine=3276811;
 //BA.debugLineNum = 3276811;BA.debugLine="SQLQuery.Append(\"WHERE Sightings.ID = ?\").Append(";
_sqlquery.Append("WHERE Sightings.ID = ?").Append(anywheresoftware.b4a.keywords.Common.CRLF);
RDebugUtils.currentLine=3276813;
 //BA.debugLineNum = 3276813;BA.debugLine="SpeciesCursor = Starter.Database.ExecQuery2(SQLQu";
...
RDebugUtils.currentLine=3276814;
 //BA.debugLineNum = 3276814;BA.debugLine="SpeciesCursor.Position = 0";
_speciescursor.setPosition((int) (0));
RDebugUtils.currentLine=3276815;
 //BA.debugLineNum = 3276815;BA.debugLine="Log(SpeciesCursor.RowCount & \"Test\")";
...
RDebugUtils.currentLine=3276817;
 //BA.debugLineNum = 3276817;BA.debugLine="For counter = 0 To SpeciesCursor.RowCount";
{
final int step15 = 1;
...
RDebugUtils.currentLine=3276818;
 //BA.debugLineNum = 3276818;BA.debugLine="BirdPhotoFile = SpeciesCursor.GetInt(\"PhotoDir\"";
_birdphotofile = _speciescursor.GetInt("PhotoDir");
RDebugUtils.currentLine=3276819;
 //BA.debugLineNum = 3276819;BA.debugLine="SightingPicture.Initialize(Main.BirdPhotoPath,B";
...
RDebugUtils.currentLine=3276820;
 //BA.debugLineNum = 3276820;BA.debugLine="SightingPhotoList.Add(SightingPicture)";
...
RDebugUtils.currentLine=3538946;
 //BA.debugLineNum = 3538946;BA.debugLine="Log(\"Code Run\")";
anywheresoftware.b4a.keywords.Common.Log("Code Run");
RDebugUtils.currentLine=3538947;
 //BA.debugLineNum = 3538947;BA.debugLine="If Position = 0 Then";
if (_position==0) { 
RDebugUtils.currentLine=3538948;
 //BA.debugLineNum = 3538948;BA.debugLine="SightingPhoto.bitmap = LoadBirdPic(SightID)";
...
RDebugUtils.currentLine=3538956;
 //BA.debugLineNum = 3538956;BA.debugLine="SightingPhoto.bitmap =  SightingPhotoList.Get(Pos";
