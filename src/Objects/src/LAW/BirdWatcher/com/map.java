...
RDebugUtils.currentLine=2883595;
 //BA.debugLineNum = 2883595;BA.debugLine="MapSetupCompleted = False";
_mapsetupcompleted = anywheresoftware.b4a.keywords.Common.False;
RDebugUtils.currentLine=2883596;
 //BA.debugLineNum = 2883596;BA.debugLine="MapTimer.Initialize(\"LootTimer\",1000)";
_maptimer.Initialize(processBA,"LootTimer",(long) (1000));
RDebugUtils.currentLine=2883598;
 //BA.debugLineNum = 2883598;BA.debugLine="Dim SpeciesCursor As Cursor";
_speciescursor = new anywheresoftware.b4a.sql.SQL.CursorWrapper();
RDebugUtils.currentLine=2883599;
 //BA.debugLineNum = 2883599;BA.debugLine="SpeciesCursor = Starter.Database.ExecQuery(\"SELEC";
...
RDebugUtils.currentLine=2883600;
 //BA.debugLineNum = 2883600;BA.debugLine="SpeciesList.clear";
mostCurrent._specieslist.Clear();
RDebugUtils.currentLine=2883602;
 //BA.debugLineNum = 2883602;BA.debugLine="For i=0 To SpeciesCursor.RowCount-1";
{
final int step11 = 1;
final int limit11 = (int) (_speciescursor.getRowCount()-1);
for (_i = (int) (0) ; (step11 > 0 && _i <= limit11) || (step11 < 0 && _i >= limit11); _i = ((int)(0 + _i + step11)) ) {
RDebugUtils.currentLine=2883603;
 //BA.debugLineNum = 2883603;BA.debugLine="SpeciesCursor.Position = i";
_speciescursor.setPosition(_i);
RDebugUtils.currentLine=2883604;
 //BA.debugLineNum = 2883604;BA.debugLine="SpeciesList.AddSingleLine2(SpeciesCursor.GetStri";
...
RDebugUtils.currentLine=3014657;
 //BA.debugLineNum = 3014657;BA.debugLine="MapTimer.Enabled = False";
...
RDebugUtils.currentLine=2949122;
 //BA.debugLineNum = 2949122;BA.debugLine="If (MapSetupCompleted = False) Then";
if ((_mapsetupcompleted==anywheresoftware.b4a.keywords.Common.False)) { 
RDebugUtils.currentLine=2949123;
 //BA.debugLineNum = 2949123;BA.debugLine="MapTimer.Enabled = True";
...
RDebugUtils.currentLine=3538944;
 //BA.debugLineNum = 3538944;BA.debugLine="Sub LoadBird(ID As Int)";
RDebugUtils.currentLine=3538945;
 //BA.debugLineNum = 3538945;BA.debugLine="ID = ID +1";
_id = (int) (_id+1);
RDebugUtils.currentLine=3538947;
 //BA.debugLineNum = 3538947;BA.debugLine="gmap.Clear";
mostCurrent._gmap.Clear();
RDebugUtils.currentLine=3538949;
 //BA.debugLineNum = 3538949;BA.debugLine="Name.Text = \"\"";
mostCurrent._name.setText((Object)(""));
RDebugUtils.currentLine=3538950;
 //BA.debugLineNum = 3538950;BA.debugLine="DateTime1.Text = \"\"";
mostCurrent._datetime1.setText((Object)(""));
RDebugUtils.currentLine=3538952;
 //BA.debugLineNum = 3538952;BA.debugLine="Dim SpeciesCursor As Cursor";
_speciescursor = new anywheresoftware.b4a.sql.SQL.CursorWrapper();
RDebugUtils.currentLine=3538953;
 //BA.debugLineNum = 3538953;BA.debugLine="Dim MapSQL As StringBuilder";
_mapsql = new anywheresoftware.b4a.keywords.StringBuilderWrapper();
RDebugUtils.currentLine=3538954;
 //BA.debugLineNum = 3538954;BA.debugLine="Dim ErrorFlag As Boolean = False";
_errorflag = anywheresoftware.b4a.keywords.Common.False;
RDebugUtils.currentLine=3538955;
 //BA.debugLineNum = 3538955;BA.debugLine="MapSQL.Initialize";
_mapsql.Initialize();
RDebugUtils.currentLine=3538957;
 //BA.debugLineNum = 3538957;BA.debugLine="MapSQL.Append(\"SELECT * FROM Sightings\").Append(C";
_mapsql.Append("SELECT * FROM Sightings").Append(anywheresoftware.b4a.keywords.Common.CRLF);
RDebugUtils.currentLine=3538958;
 //BA.debugLineNum = 3538958;BA.debugLine="MapSQL.Append(\"WHERE ID = ?\").Append(CRLF)";
_mapsql.Append("WHERE ID = ?").Append(anywheresoftware.b4a.keywords.Common.CRLF);
RDebugUtils.currentLine=3538959;
 //BA.debugLineNum = 3538959;BA.debugLine="MapSQL.Append(\"ORDER BY ID Asc\").Append(CRLF)";
_mapsql.Append("ORDER BY ID Asc").Append(anywheresoftware.b4a.keywords.Common.CRLF);
RDebugUtils.currentLine=3538960;
 //BA.debugLineNum = 3538960;BA.debugLine="ErrorFlag= False";
_errorflag = anywheresoftware.b4a.keywords.Common.False;
RDebugUtils.currentLine=3538961;
 //BA.debugLineNum = 3538961;BA.debugLine="SpeciesCursor = Starter.Database.ExecQuery2(MapSQ";
...
RDebugUtils.currentLine=3538964;
 //BA.debugLineNum = 3538964;BA.debugLine="For i=0 To SpeciesCursor.RowCount-1";
{
final int step14 = 1;
...
RDebugUtils.currentLine=3538966;
 //BA.debugLineNum = 3538966;BA.debugLine="SpeciesCursor.Position = i";
_speciescursor.setPosition(_i);
RDebugUtils.currentLine=3538968;
 //BA.debugLineNum = 3538968;BA.debugLine="Dim SightingMarker As Marker";
_sightingmarker = new anywheresoftware.b4a.objects.MapFragmentWrapper.MarkerWrapper();
RDebugUtils.currentLine=3538972;
 //BA.debugLineNum = 3538972;BA.debugLine="Log(\"LAT: \" & SpeciesCursor.GetDouble(\"Lat\"))";
...
RDebugUtils.currentLine=3538973;
 //BA.debugLineNum = 3538973;BA.debugLine="Log(\"LNG: \" & SpeciesCursor.GetDouble(\"Lng\"))";
...
RDebugUtils.currentLine=3473408;
 //BA.debugLineNum = 3473408;BA.debugLine="Sub LoadBirdPic(BirdID As Int)";
RDebugUtils.currentLine=3473409;
 //BA.debugLineNum = 3473409;BA.debugLine="BirdID = BirdID +1";
_birdid = (int) (_birdid+1);
RDebugUtils.currentLine=3473411;
 //BA.debugLineNum = 3473411;BA.debugLine="Dim NewBird As Bitmap";
_newbird = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
RDebugUtils.currentLine=3473412;
 //BA.debugLineNum = 3473412;BA.debugLine="NewBird.InitializeSample(File.DirAssets,BirdID  &";
...
RDebugUtils.currentLine=3473413;
 //BA.debugLineNum = 3473413;BA.debugLine="BirdImage.Bitmap = NewBird";
...
RDebugUtils.currentLine=3080192;
 //BA.debugLineNum = 3080192;BA.debugLine="Sub LootTimer_Tick";
RDebugUtils.currentLine=3080196;
 //BA.debugLineNum = 3080196;BA.debugLine="If ((gmap.IsInitialized) And (gmap.MyLocation.IsI";
if (((mostCurrent._gmap.IsInitialized()) && (mostCurrent._gmap.getMyLocation().IsInitialized()))) { 
RDebugUtils.currentLine=3080197;
 //BA.debugLineNum = 3080197;BA.debugLine="MapSetupCompleted = True";
_mapsetupcompleted = anywheresoftware.b4a.keywords.Common.True;
RDebugUtils.currentLine=3080198;
 //BA.debugLineNum = 3080198;BA.debugLine="MapTimer.Enabled = False";
_maptimer.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 };
...
RDebugUtils.currentLine=3407872;
 //BA.debugLineNum = 3407872;BA.debugLine="Sub MainMap_MarkerClick (SelectedMarker As Marker)";
RDebugUtils.currentLine=3407874;
 //BA.debugLineNum = 3407874;BA.debugLine="Dim BirdCursor As Cursor";
_birdcursor = new anywheresoftware.b4a.sql.SQL.CursorWrapper();
RDebugUtils.currentLine=3407875;
 //BA.debugLineNum = 3407875;BA.debugLine="Dim MapSQL As String";
_mapsql = "";
RDebugUtils.currentLine=3407878;
 //BA.debugLineNum = 3407878;BA.debugLine="If (SelectedMarker.Snippet = \"0\") Then";
if (((_selectedmarker.getSnippet()).equals("0"))) { 
RDebugUtils.currentLine=3407879;
 //BA.debugLineNum = 3407879;BA.debugLine="ToastMessageShow(\"Location new loot to be added";
...
RDebugUtils.currentLine=3407885;
 //BA.debugLineNum = 3407885;BA.debugLine="MapSQL = \"SELECT * FROM Sightings WHERE ID = ?\"";
_mapsql = "SELECT * FROM Sightings WHERE ID = ?";
RDebugUtils.currentLine=3407887;
 //BA.debugLineNum = 3407887;BA.debugLine="BirdCursor = Starter.Database.ExecQuery2(MapSQL,";
...
RDebugUtils.currentLine=3407888;
 //BA.debugLineNum = 3407888;BA.debugLine="BirdCursor.Position = 0";
_birdcursor.setPosition((int) (0));
RDebugUtils.currentLine=3407891;
 //BA.debugLineNum = 3407891;BA.debugLine="Name.Text = BirdCursor.GetString(\"Weather\")";
mostCurrent._name.setText((Object)(_birdcursor.GetString("Weather")));
RDebugUtils.currentLine=3407892;
 //BA.debugLineNum = 3407892;BA.debugLine="DateTime1.Text = DateTime.Date(BirdCursor.GetStri";
...
RDebugUtils.currentLine=3407896;
 //BA.debugLineNum = 3407896;BA.debugLine="Return True 'stop the little pop up text box from";
if (true) return anywheresoftware.b4a.keywords.Common.True;
...
RDebugUtils.currentLine=3211264;
 //BA.debugLineNum = 3211264;BA.debugLine="Sub MainMap_Ready";
RDebugUtils.currentLine=3211265;
 //BA.debugLineNum = 3211265;BA.debugLine="gmap = MainMap.GetMap";
mostCurrent._gmap = mostCurrent._mainmap.GetMap();
RDebugUtils.currentLine=3211267;
 //BA.debugLineNum = 3211267;BA.debugLine="Log(\"Mylocation:\" & gmap.MyLocationEnabled)";
...
RDebugUtils.currentLine=3145728;
 //BA.debugLineNum = 3145728;BA.debugLine="Sub MainScreen_Click";
...
RDebugUtils.currentLine=3342336;
 //BA.debugLineNum = 3342336;BA.debugLine="Sub MapTestButton_Click";
RDebugUtils.currentLine=3342338;
 //BA.debugLineNum = 3342338;BA.debugLine="SetupMapLocation";
_setupmaplocation();
...
RDebugUtils.currentLine=3276800;
 //BA.debugLineNum = 3276800;BA.debugLine="Sub SetupMapLocation";
RDebugUtils.currentLine=3276802;
 //BA.debugLineNum = 3276802;BA.debugLine="Dim p As Phone";
_p = new anywheresoftware.b4a.phone.Phone();
RDebugUtils.currentLine=3276806;
 //BA.debugLineNum = 3276806;BA.debugLine="If ((Starter.GPS1.GPSEnabled) And (p.IsAirplaneMo";
if (((mostCurrent._starter._gps1.getGPSEnabled()) && (_p.IsAirplaneModeOn()==anywheresoftware.b4a.keywords.Common.False))) { 
RDebugUtils.currentLine=3276808;
 //BA.debugLineNum = 3276808;BA.debugLine="Dim NewMapPosition As CameraPosition";
_newmapposition = new anywheresoftware.b4a.objects.MapFragmentWrapper.CameraPositionWrapper();
RDebugUtils.currentLine=3276809;
 //BA.debugLineNum = 3276809;BA.debugLine="NewMapPosition.Initialize(gmap.MyLocation.Latitu";
...
RDebugUtils.currentLine=3276810;
 //BA.debugLineNum = 3276810;BA.debugLine="gmap.MoveCamera(NewMapPosition)";
...
RDebugUtils.currentLine=3276812;
 //BA.debugLineNum = 3276812;BA.debugLine="If (p.IsAirplaneModeOn) Then";
if ((_p.IsAirplaneModeOn())) { 
RDebugUtils.currentLine=3276813;
 //BA.debugLineNum = 3276813;BA.debugLine="ToastMessageShow(\"Airplane mode is enabled. Int";
...
RDebugUtils.currentLine=3276817;
 //BA.debugLineNum = 3276817;BA.debugLine="ToastMessageShow(\"Device GPS is disabled. Pleas";
...
RDebugUtils.currentLine=3276818;
 //BA.debugLineNum = 3276818;BA.debugLine="StartActivity(Starter.GPS1.LocationSettingsInte";
...
RDebugUtils.currentLine=3670016;
 //BA.debugLineNum = 3670016;BA.debugLine="Sub MoreInfo_Click";
RDebugUtils.currentLine=3670017;
 //BA.debugLineNum = 3670017;BA.debugLine="Sightings.MapLookupFlag = True";
mostCurrent._sightings._maplookupflag = anywheresoftware.b4a.keywords.Common.True;
RDebugUtils.currentLine=3670018;
 //BA.debugLineNum = 3670018;BA.debugLine="StartActivity(Sightings)";
...
RDebugUtils.currentLine=3604480;
 //BA.debugLineNum = 3604480;BA.debugLine="Sub SpeciesList_ItemClick (Position As Int, Value";
RDebugUtils.currentLine=3604481;
 //BA.debugLineNum = 3604481;BA.debugLine="SelectedID = Value -1";
_selectedid = (int) ((double)(BA.ObjectToNumber(_value))-1);
RDebugUtils.currentLine=3604482;
 //BA.debugLineNum = 3604482;BA.debugLine="If Position = -1 Then";
if (_position==-1) { 
RDebugUtils.currentLine=3604483;
 //BA.debugLineNum = 3604483;BA.debugLine="Return";
if (true) return "";
 };
RDebugUtils.currentLine=3604485;
 //BA.debugLineNum = 3604485;BA.debugLine="LoadBirdPic(SelectedID)";
_loadbirdpic(_selectedid);
RDebugUtils.currentLine=3604486;
 //BA.debugLineNum = 3604486;BA.debugLine="LoadBird(SelectedID)";
